...
/* Object interface: IATLControl, ver. 0.0,
   GUID={0x5b1ed8ae,0x4db2,0x4979,{0x93,0x83,0x6a,0x2b,0xf9,0x7d,0x47,0x41}} */
...
/* get_FillColor */
    { 
    /* get_FillColor */      /* procedure get_FillColor */
...
/* put_FillColor */
    { 
    /* put_FillColor */      /* procedure put_FillColor */
        (NDR64_UINT32) 524611 /* 0x80143 */,    /* auto handle */ /* IsIntrepreted, [object], HasReturn */
        (NDR64_UINT32) 24 /* 0x18 */ ,  /* Stack size */
        (NDR64_UINT32) 8 /* 0x8 */,
        (NDR64_UINT32) 8 /* 0x8 */,
...
CINTERFACE_PROXY_VTABLE(9) _IATLControlProxyVtbl = 
{
    ...
    (void *) (INT_PTR) -1 /* IATLControl::put_FillColor */ ,
    (void *) (INT_PTR) -1 /* IATLControl::get_FillColor */
};


EXTERN_C DECLSPEC_SELECTANY const PRPC_STUB_FUNCTION IATLControl_table[] =
{
